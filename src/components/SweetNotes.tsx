        ...
        <div className="mb-8">
          ...
          <div className="relative">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="absolute bottom-3 right-3 p-2 rounded-full bg-pink-500 text-white
              ...
              <AnimatePresence>
                {selectedNote === note.id && (
                  <motion.div
                    ...
                    className="note-menu absolute right-2 top-2 flex gap-1 bg-white/90 
                             rounded-full shadow-lg border border-pink-100 p-1"
                  >
                    <motion.button
